...
const TERMINAL =
  "C:\\inteligencia-artificial\\repos-cursor\\ops\\omniroute-start-terminal.cmd";
...
process.stdin.on("end", async () => {
  ...
  const context = [
    ...
    up
      ...
      : "- Status ao sessionStart: porta 20128 DOWN — omniroute-ensure.cmd disparado em background.",
    "- Health: " + HEALTH,
    "- Ensure: " + ENSURE,
    "- Terminal dedicado: " + TERMINAL,
