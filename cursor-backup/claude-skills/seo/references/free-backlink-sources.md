...
- **Command:** `"$HOME/.claude/skills/seo/bin/claude-seo" run moz_api.py`
...
- **Command:** `"$HOME/.claude/skills/seo/bin/claude-seo" run bing_webmaster.py`
...
- **Command:** `"$HOME/.claude/skills/seo/bin/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `"$HOME/.claude/skills/seo/bin/claude-seo" run verify_backlinks.py`
